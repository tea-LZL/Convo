...
pub fn run() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            // Models
            models_cmd::cancel_model_pull,
            models_cmd::create_custom_model_for_provider,
            models_cmd::delete_model_for_provider,
            models_cmd::list_all_models,
            models_cmd::list_local_servers,
            models_cmd::list_models_for_provider,
            models_cmd::pull_model_for_provider,
            models_cmd::refresh_models,
            // Messages + chat
            chat_cmd::append_message,
            chat_cmd::clear_messages,
            chat_cmd::delete_message,
